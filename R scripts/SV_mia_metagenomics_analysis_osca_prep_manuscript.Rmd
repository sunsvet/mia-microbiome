...
author: "by Chloe Yap - `r format(Sys.time(), '%d %B %Y')` edited by Svetlina Vasileva"
output:
  html_document:
    self_contained: no
  epuRate::PCTG:
...
```{r}
rm(list = ls())
setwd("C:/Users/uqsvasil/Documents/PhD/MIA/Data")

# Directories
taxa_dir <- "C:/Users/uqsvasil/Documents/PhD/MIA/Data/processed_data/taxonomic_profiles/profiles_relativeabundance_AAB.tsv"
taxa_count_dir <- "C:/Users/uqsvasil/Documents/PhD/MIA/Data/processed_data/taxonomic_profiles/profiles_counts_AAB.tsv"
ec_dir <- "C:/Users/uqsvasil/Documents/PhD/MIA/Data/processed_data/functional_profiles/by_sample/EC.samples_AAB.tsv"
tcdb_dir <- "C:/Users/uqsvasil/Documents/PhD/MIA/Data/processed_data/functional_profiles/by_sample/TCDB.samples_AAB.tsv"
mcpath_dir <- "C:/Users/uqsvasil/Documents/PhD/MIA/Data/processed_data/functional_profiles/by_sample/MetaCyc_pathways.samples_AAB.tsv"
func_dir <- "C:/Users/uqsvasil/Documents/PhD/MIA/Data/processed_data/functional_profiles/by_sample/MICROBA.samples_AAB.tsv"
diet_dir <- "C:/Users/uqsvasil/Documents/PhD/MIA/Data/diet_mia_mats_age_full.csv"
...
taxa_count[nrow(taxa_count), "Taxon"] <- "s__UNASSIGNED"
...
zero_rows <- which(rowSums(ec == 0) == ncol(ec))
...
# Find rows where all values are 0
zero_rows <- which(rowSums(tcdb == 0) == ncol(tcdb))
...
# Find rows where all values are 0
zero_rows <- which(rowSums(mcpath == 0) == ncol(mcpath))
...
#### Microba genes (functional) table
...
# Find rows where all values are 0
zero_rows <- which(rowSums(func == 0) == ncol(func))
...
## Collapse to species
- N= 1,751
- n=91 common species passing filters
...
write.table(species_stats, "C:/Users/uqsvasil/Documents/PhD/MIA/OSCA/OSCA_prep/taxa_count_species_stats.txt",
...
foo <- as.numeric(taxa_count_species_common[31,2:ncol(taxa_count_species_common)])
hist(foo)
...
tmp <- as.matrix(t(taxa_count_species_common_clr[,2:ncol(taxa_count_species_common_clr)])) #transpose it
...
write.table(osca_out, "C:/Users/uqsvasil/Documents/PhD/MIA/OSCA/OSCA_prep/taxa_count_species_common_clrcheck_t.tsv", 	col.names = T, row.names = F, sep = "\t", quote = F)
...
write.table(genus_stats, "C:/Users/uqsvasil/Documents/PhD/MIA/OSCA/OSCA_prep/taxa_count_genus_stats.txt",
	col.names = T, row.names = F, quote = F, sep = "\t")
...
tmp <- as.matrix(t(taxa_count_genus_common_clr[,2:ncol(taxa_count_genus_common_clr)])) # transpose it 
...
write.table(osca_out, "C:/Users/uqsvasil/Documents/PhD/MIA/OSCA/OSCA_prep/taxa_count_genus_common_clrcheck_t.tsv", 	col.names = T, row.names = F, sep = "\t", quote = F)
...
write.table(family_stats, "C:/Users/uqsvasil/Documents/PhD/MIA/OSCA/OSCA_prep/taxa_count_family_stats.txt",
	col.names = T, row.names = F, quote = F, sep = "\t")
...
tmp <- as.matrix(t(taxa_count_family_common_clr[,2:ncol(taxa_count_family_common_clr)])) # transpose it 
...
write.table(osca_out, "C:/Users/uqsvasil/Documents/PhD/MIA/OSCA/OSCA_prep/taxa_count_family_common_clrcheck_t.tsv", 	col.names = T, row.names = F, sep = "\t", quote = F)
...
#### Select only bacterial species 
- currently there is one archaea (s__Methanobrevibacter_A smithii) and one eukaryota (s__Blastocystis sp. subtype 3)

```{r}

# remove non-bacteria taxa
taxa_count_species_rm0_clr_t_bacteria <- taxa_count_species_rm0_clr_t %>%
  select(-c("s__Methanobrevibacter_A.smithii", "s__Blastocystis.sp..subtype.3", "s__UNASSIGNED"))
...
osca_out <- osca_out %>%
  select(-c("s__UNASSIGNED")) # remove unassigned reads
write.table(osca_out, "C:/Users/uqsvasil/Documents/PhD/MIA/OSCA/OSCA_prep/taxa_count_species_rm0_clrcheck_t.tsv", 	col.names = T, row.names = F, sep = "\t", quote = F)

# 2. Matrix only for bacterial species
identical(taxa_count_species_rm0_clr_t$MG_SampleID, diet_full$MG_SampleID)
osca_out <- data.table(FID = diet_full$IID, IID = diet_full$IID, taxa_count_species_rm0_clr_t[,2:ncol(taxa_count_species_rm0_clr_t)])
osca_out <- osca_out %>%
  select(-c("s__Methanobrevibacter_A.smithii", "s__Blastocystis.sp..subtype.3", "s__UNASSIGNED")) # remove non-bacterial and unassigned
write.table(osca_out, "C:/Users/uqsvasil/Documents/PhD/MIA/OSCA/OSCA_prep/taxa_count_species_rm0_clrcheck_t_bacteria.tsv", 	col.names = T, row.names = F, sep = "\t", quote = F)
...
species_stats <- fread("C:/Users/uqsvasil/Documents/PhD/MIA/OSCA/OSCA_prep/taxa_count_species_stats.txt")
...
write.table(osca_out, "C:/Users/uqsvasil/Documents/PhD/MIA/OSCA/OSCA_prep/taxa_count_species_rm0_rare_clrcheck_t.tsv", 	col.names = T, row.names = F, sep = "\t", quote = F)

# 2. Matrix only for bacterial species
identical(taxa_count_species_rm0_rare_clr_t$MG_SampleID, diet_full$MG_SampleID)
osca_out <- data.table(FID = diet_full$IID, IID = diet_full$IID, taxa_count_species_rm0_rare_clr_t[,2:ncol(taxa_count_species_rm0_rare_clr_t)])
osca_out <- osca_out %>%
  select(-c("Methanobrevibacter_A.smithii", "Blastocystis.sp..subtype.3")) # remove non-bacterial and unassigned
write.table(osca_out, "C:/Users/uqsvasil/Documents/PhD/MIA/OSCA/OSCA_prep/taxa_count_species_rm0_rare_clrcheck_t_bacteria.tsv", 	col.names = T, row.names = F, sep = "\t", quote = F)
...
write.table(osca_out, "C:/Users/uqsvasil/Documents/PhD/MIA/OSCA/OSCA_prep/taxa_count_species_rm0_rare_01_t.tsv", 	col.names = T, row.names = F, sep = "\t", quote = F)
...
osca_out <- osca_out %>%
  select(-c("Methanobrevibacter_A.smithii", "Blastocystis.sp..subtype.3")) # remove non-bacterial and unassigned
write.table(osca_out, "C:/Users/uqsvasil/Documents/PhD/MIA/OSCA/OSCA_prep/taxa_count_species_rm0_rare_01_t_bacteria.tsv", 	col.names = T, row.names = F, sep = "\t", quote = F)
...
- Level 4 classification: n=2271 --> n=1610 after filtering for median > 0
...
write.table(ec_stats, "C:/Users/uqsvasil/Documents/PhD/MIA/OSCA/OSCA_prep/func_count_EClevel4_stats.txt",
	col.names = T, row.names = F, quote = F, sep = "\t")
...
write.table(osca_out, "C:/Users/uqsvasil/Documents/PhD/MIA/OSCA/OSCA_prep/func_count_EClevel4_common_clrcheck_t.tsv", 	col.names = T, row.names = F, sep = "\t", quote = F)
...
ec_stats <- fread("C:/Users/uqsvasil/Documents/PhD/MIA/OSCA/OSCA_prep/func_count_EClevel4_stats.txt")
...
write.table(osca_out, "C:/Users/uqsvasil/Documents/PhD/MIA/OSCA/OSCA_prep/func_count_EClevel4_rm0_rare_clrcheck_t.tsv", 	col.names = T, row.names = F, sep = "\t", quote = F)
...
write.table(osca_out, "C:/Users/uqsvasil/Documents/PhD/MIA/OSCA/OSCA_prep/func_count_EClevel4_rm0_rare_01_t.tsv", 	col.names = T, row.names = F, sep = "\t", quote = F)
...
- Enzyme commission naming system: 4 levels, with increasingly finer classification (eg. 1.1.1.1, if denoting a higher level --> 1.1.-.-)
- Level 3 classification: n=99 --> n=87 after filtering for median > 0
- Classification is based on the chemical reactions that the enzymes catalyses 
- https://en.wikipedia.org/wiki/Enzyme_Commission_number
...
write.table(ec_stats, "C:/Users/uqsvasil/Documents/PhD/MIA/OSCA/OSCA_prep/func_count_EClevel3_stats.txt",
	col.names = T, row.names = F, quote = F, sep = "\t")
...
identical(ec_common_clr_t$MG_SampleID, diet_full$MG_SampleID)
osca_out <- data.table(FID = diet_full$IID, IID = diet_full$IID, ec_common_clr_t[,2:ncol(ec_common_clr_t)])
write.table(osca_out, "C:/Users/uqsvasil/Documents/PhD/MIA/OSCA/OSCA_prep/func_count_EClevel3_common_clrcheck_t.tsv", 	col.names = T, row.names = F, sep = "\t", quote = F)
...
write.table(tcdb_stats, "C:/Users/uqsvasil/Documents/PhD/MIA/OSCA/OSCA_prep/func_count_TCDB_stats.txt",
	col.names = T, row.names = F, quote = F, sep = "\t")
...
write.table(osca_out, "C:/Users/uqsvasil/Documents/PhD/MIA/OSCA/OSCA_prep/func_count_TCDB_common_clrcheck_t.tsv", 	col.names = T, row.names = F, sep = "\t", quote = F)
...
write.table(mcpath_stats, "C:/Users/uqsvasil/Documents/PhD/MIA/OSCA/OSCA_prep/func_count_MetaCycpathway_stats.txt",
	col.names = T, row.names = F, quote = F, sep = "\t")
...
write.table(osca_out, "C:/Users/uqsvasil/Documents/PhD/MIA/OSCA/OSCA_prep/func_count_MetaCycpathway_common_clrcheck_t.tsv", 	col.names = T, row.names = F, sep = "\t", quote = F)

```

## Take Microba gene functional tables

- start with 3001133 genes
...
write.table(func_stats, "C:/Users/uqsvasil/Documents/PhD/MIA/OSCA/OSCA_prep/func_count_Microba_stats.txt",
	col.names = T, row.names = F, quote = F, sep = "\t")
...
func_stats <- read.delim("C:/Users/uqsvasil/Documents/PhD/MIA/OSCA/OSCA_prep/func_count_Microba_stats.txt", header = T, as.is = T)
...
write.table(osca_out, "C:/Users/uqsvasil/Documents/PhD/MIA/OSCA/OSCA_prep/func_count_Microba_common_clrcheck_t.tsv", col.names = T, row.names = F, sep = "\t", quote = F)
...
func_stats <- fread("C:/Users/uqsvasil/Documents/PhD/MIA/OSCA/OSCA_prep/func_count_Microba_stats.txt")
...
write.table(osca_out, "C:/Users/uqsvasil/Documents/PhD/MIA/OSCA/OSCA_prep/func_count_Microba_rm0_rare_clrcheck_t.tsv", col.names = T, row.names = F, sep = "\t", quote = F)

```

## Generate other outputs for OSCA

### 1. MIA analysis: pheno + covariate files

- pheno: MIA/noMIA, MatS/noMatS
- cov: create both with and without bristol stool chart
- qcov: create both with and without dietary PCs

```{r}
# Take diet file with phenotypes
pheno <- diet_full[,c("IID", "IID", "ASD","age", "participant_type", "mia_indication", "mia_number", "mats_indication", "mats_number","me_indication","me_number", "bmi", "sex", "bristol_stool_chart_regroup", "sleep_cshq_total", "devq_wisc_msel", "meds_antibiotic_current", "meds_antipsychotic","meds_gastrointestinal","cam_probiotic", "mia_subgroup")]


# Make into binary files
pheno$ASD <- ifelse(pheno$ASD == "ASD", 1, 0)
pheno$sex <-ifelse(pheno$sex == "F", 0, 1)
pheno$mia_indication <- ifelse(pheno$mia_indication == "MIA", 1, 0)
pheno$mats_indication <- ifelse(pheno$mats_indication == "MatS", 1, 0)
pheno$me_indication <- ifelse(pheno$me_indication == "ME", 1, 0)
pheno$participant_type <- factor(pheno$participant_type, levels = c("UNR", "SIB", "ASD"), labels = c(0, 1, 2))

colnames(pheno)[1:2] <- c("FID", "IID")  # change IID to FID
cov <- diet_full[,c("IID", "IID", "sex")]
colnames(cov)[1:2] <- c("FID", "IID")  # change IID to FID
...
# Pheno adjusted for sex + age + PC1_diet_pe + PC2_diet_pe + PC3_diet_pe (logistic regression)
pheno_resid <- glm(pheno$mia_indication ~ sex + age + ASD + mats_indication + PC1_diet_pe + PC2_diet_pe + PC3_diet_pe, data = diet_full, family = "binomial")
summary(pheno_resid)
pheno$MIA_adjsexagediet <- residuals(pheno_resid)
...
```{r}
# MIA pheno
write.table(pheno %>% dplyr::select(c("FID", "IID", "mia_indication")), 
	"C:/Users/uqsvasil/Documents/PhD/MIA/OSCA/OSCA_prep/osca_metagenomics_mia_indication.pheno",
	col.names = F, row.names = F, sep = "\t", quote = F)

# MatS pheno
write.table(pheno %>% dplyr::select(c("FID", "IID", "mats_indication")), 
	"C:/Users/uqsvasil/Documents/PhD/MIA/OSCA/OSCA_prep/osca_metagenomics_mats_indication.pheno",
	col.names = F, row.names = F, sep = "\t", quote = F)

# ME pheno
write.table(pheno %>% dplyr::select(c("FID", "IID", "me_indication")), 
	"C:/Users/uqsvasil/Documents/PhD/MIA/OSCA/OSCA_prep/osca_metagenomics_me_indication.pheno",
	col.names = F, row.names = F, sep = "\t", quote = F)

# ASD pheno
write.table(pheno %>% dplyr::select(c("FID", "IID", "ASD")), 
	"C:/Users/uqsvasil/Documents/PhD/MIA/OSCA/OSCA_prep/osca_metagenomics_ASD.pheno",
	col.names = F, row.names = F, sep = "\t", quote = F)

# Participant_type
write.table(pheno %>% dplyr::select(c("FID", "IID", "participant_type")), 
	"C:/Users/uqsvasil/Documents/PhD/MIA/OSCA/OSCA_prep/osca_metagenomics_participant_type.pheno",
	col.names = F, row.names = F, sep = "\t", quote = F)

# MIA number
write.table(pheno %>% dplyr::select(c("FID", "IID", "mia_number")), 
	"C:/Users/uqsvasil/Documents/PhD/MIA/OSCA/OSCA_prep/osca_metagenomics_mia_number.pheno",
	col.names = F, row.names = F, sep = "\t", quote = F)

# MIA subgroup
write.table(pheno %>% dplyr::select(c("FID", "IID", "mia_subgroup")), 
	"C:/Users/uqsvasil/Documents/PhD/MIA/OSCA/OSCA_prep/osca_metagenomics_mia_subgroup.pheno",
	col.names = F, row.names = F, sep = "\t", quote = F)

# MatS number
write.table(pheno %>% dplyr::select(c("FID", "IID", "mats_number")), 
	"C:/Users/uqsvasil/Documents/PhD/MIA/OSCA/OSCA_prep/osca_metagenomics_mats_number.pheno",
	col.names = F, row.names = F, sep = "\t", quote = F)

# ME number
write.table(pheno %>% dplyr::select(c("FID", "IID", "me_number")), 
	"C:/Users/uqsvasil/Documents/PhD/MIA/OSCA/OSCA_prep/osca_metagenomics_me_number.pheno",
	col.names = F, row.names = F, sep = "\t", quote = F)

# Other pheno: BMI, sleep, stool, wisc
write.table(pheno %>% dplyr::select(c("FID", "IID", "MIA_adjsexagediet")), 
	"C:/Users/uqsvasil/Documents/PhD/MIA/OSCA/OSCA_prep/osca_metagenomics_mia_resid_sex_age_dietPC.pheno",
	col.names = F, row.names = F, sep = "\t", quote = F)
write.table(pheno %>% dplyr::select(c("FID", "IID", "bristol_stool_chart_regroup")), 
	"C:/Users/uqsvasil/Documents/PhD/MIA/OSCA/OSCA_prep/osca_metagenomics_bristol.pheno",
	col.names = F, row.names = F, sep = "\t", quote = F)
write.table(pheno %>% dplyr::select(c("FID", "IID", "bmi")), 
	"C:/Users/uqsvasil/Documents/PhD/MIA/OSCA/OSCA_prep/osca_metagenomics_bmi.pheno",
	col.names = F, row.names = F, sep = "\t", quote = F)
write.table(pheno %>% dplyr::select(c("FID", "IID", "sleep_cshq_total")), 
	"C:/Users/uqsvasil/Documents/PhD/MIA/OSCA/OSCA_prep/osca_metagenomics_sleep_cshq_total.pheno",
	col.names = F, row.names = F, sep = "\t", quote = F)
write.table(pheno %>% dplyr::select(c("FID", "IID", "devq_wisc_msel")), 
	"C:/Users/uqsvasil/Documents/PhD/MIA/OSCA/OSCA_prep/osca_metagenomics_devq_wisc_msel.pheno",
	col.names = F, row.names = F, sep = "\t", quote = F)
write.table(pheno %>% dplyr::select(c("FID", "IID", "age")), 
	"C:/Users/uqsvasil/Documents/PhD/MIA/OSCA/OSCA_prep/osca_metagenomics_age.pheno",
	col.names = F, row.names = F, sep = "\t", quote = F)
write.table(pheno %>% dplyr::select(c("FID", "IID", "sex")), 
	"C:/Users/uqsvasil/Documents/PhD/MIA/OSCA/OSCA_prep/osca_metagenomics_sex.pheno",
	col.names = F, row.names = F, sep = "\t", quote = F)
write.table(pheno %>% dplyr::select(c("FID", "IID", "meds_antibiotic_current")), 
	"C:/Users/uqsvasil/Documents/PhD/MIA/OSCA/OSCA_prep/osca_metagenomics_meds_antibiotic_current.pheno",
	col.names = F, row.names = F, sep = "\t", quote = F)
write.table(pheno %>% dplyr::select(c("FID", "IID", "meds_antipsychotic")), 
	"C:/Users/uqsvasil/Documents/PhD/MIA/OSCA/OSCA_prep/osca_metagenomics_meds_antipsychotic.pheno",
	col.names = F, row.names = F, sep = "\t", quote = F)
write.table(pheno %>% dplyr::select(c("FID", "IID", "meds_gastrointestinal")), 
	"C:/Users/uqsvasil/Documents/PhD/MIA/OSCA/OSCA_prep/osca_metagenomics_meds_gastrointestinal.pheno",
	col.names = F, row.names = F, sep = "\t", quote = F)
write.table(pheno %>% dplyr::select(c("FID", "IID", "cam_probiotic")), 
	"C:/Users/uqsvasil/Documents/PhD/MIA/OSCA/OSCA_prep/osca_metagenomics_cam_probiotic.pheno",
	col.names = F, row.names = F, sep = "\t", quote = F)
...
# Discrete covariates: Sex, MatS, ASD
write.table(pheno %>% dplyr::select(c("FID", "IID", "proforma_sex")), 
	"C:/Users/uqsvasil/Documents/PhD/MIA/OSCA/OSCA_prep/osca_metagenomics_sex.cov",
	col.names = F, row.names = F, sep = "\t", quote = F)
write.table(pheno %>% dplyr::select(c("FID", "IID", "mats_indication")), 
	"C:/Users/uqsvasil/Documents/PhD/MIA/OSCA/OSCA_prep/osca_metagenomics_mats_indication.cov",
	col.names = F, row.names = F, sep = "\t", quote = F)
write.table(pheno %>% dplyr::select(c("FID", "IID", "mia_indication")), 
	"C:/Users/uqsvasil/Documents/PhD/MIA/OSCA/OSCA_prep/osca_metagenomics_mia_indication.cov",
	col.names = F, row.names = F, sep = "\t", quote = F)
write.table(pheno %>% dplyr::select(c("FID", "IID", "ASD")), 
	"C:/Users/uqsvasil/Documents/PhD/MIA/OSCA/OSCA_prep/osca_metagenomics_ASD.cov",
	col.names = F, row.names = F, sep = "\t", quote = F)
write.table(pheno %>% dplyr::select(c("FID", "IID", "participant_type")), 
	"C:/Users/uqsvasil/Documents/PhD/MIA/OSCA/OSCA_prep/osca_metagenomics_paticipant_type.cov",
	col.names = F, row.names = F, sep = "\t", quote = F)


write.table(pheno %>% dplyr::select(c("FID", "IID", "proforma_sex","ASD")), 
	"C:/Users/uqsvasil/Documents/PhD/MIA/OSCA/OSCA_prep/osca_metagenomics_sex_ASD.cov",
	col.names = F, row.names = F, sep = "\t", quote = F)
write.table(pheno %>% dplyr::select(c("FID", "IID", "proforma_sex","ASD","mia_indication")), 
	"C:/Users/uqsvasil/Documents/PhD/MIA/OSCA/OSCA_prep/osca_metagenomics_sex_ASD_mia_indication.cov",
	col.names = F, row.names = F, sep = "\t", quote = F)
write.table(pheno %>% dplyr::select(c("FID", "IID", "proforma_sex","ASD","mats_indication")), 
	"C:/Users/uqsvasil/Documents/PhD/MIA/OSCA/OSCA_prep/osca_metagenomics_sex_ASD_mats_indication.cov",
	col.names = F, row.names = F, sep = "\t", quote = F)
...
write.table(qcov, 
	"C:/Users/uqsvasil/Documents/PhD/MIA/OSCA/OSCA_prep/osca_metagenomics_age_dietPC_bristol.qcov",
	col.names = F, row.names = F, sep = "\t", quote = F)
write.table(qcov %>% dplyr::select(-c("bristol_stool_chart_regroup")), 
	"C:/Users/uqsvasil/Documents/PhD/MIA/OSCA/OSCA_prep/osca_metagenomics_age_dietPC.qcov",
	col.names = F, row.names = F, sep = "\t", quote = F)
write.table(qcov %>% dplyr::select(-c("PC1_diet_pe", "PC2_diet_pe", "PC3_diet_pe", "bristol_stool_chart_regroup")), 
	"C:/Users/uqsvasil/Documents/PhD/MIA/OSCA/OSCA_prep/osca_metagenomics_age.qcov",
	col.names = F, row.names = F, sep = "\t", quote = F)

write.table(pheno %>% dplyr::select(c("FID", "IID", "mia_number")), 
	"C:/Users/uqsvasil/Documents/PhD/MIA/OSCA/OSCA_prep/osca_metagenomics_mia_number.qcov",
	col.names = F, row.names = F, sep = "\t", quote = F)

write.table(pheno %>% dplyr::select(c("FID", "IID", "mats_number")), 
	"C:/Users/uqsvasil/Documents/PhD/MIA/OSCA/OSCA_prep/osca_metagenomics_mats_number.qcov",
	col.names = F, row.names = F, sep = "\t", quote = F)
...
colnames(pheno_diet)[1:2] <- c("FID", "IID")  # change IID to FID
...
# Pheno - raw
write.table(pheno_diet %>% dplyr::select(c("FID", "IID", "PC1_diet_pe")), 
	"C:/Users/uqsvasil/Documents/PhD/MIA/OSCA/OSCA_prep/osca_metagenomics_dietPC1.pheno",
	col.names = F, row.names = F, sep = "\t", quote = F)
write.table(pheno_diet %>% dplyr::select(c("FID", "IID", "PC2_diet_pe")), 
	"C:/Users/uqsvasil/Documents/PhD/MIA/OSCA/OSCA_prep/osca_metagenomics_dietPC2.pheno",
	col.names = F, row.names = F, sep = "\t", quote = F)
write.table(pheno_diet %>% dplyr::select(c("FID", "IID", "PC3_diet_pe")), 
	"C:/Users/uqsvasil/Documents/PhD/MIA/OSCA/OSCA_prep/osca_metagenomics_dietPC3.pheno",
	col.names = F, row.names = F, sep = "\t", quote = F)

# Pheno - adjusted
write.table(pheno_diet %>% dplyr::select(c("FID", "IID", "PC1_adjsexagegroup")), 
	"C:/Users/uqsvasil/Documents/PhD/MIA/OSCA/OSCA_prep/osca_metagenomics_dietPC1_preadj.pheno",
	col.names = F, row.names = F, sep = "\t", quote = F)
write.table(pheno_diet %>% dplyr::select(c("FID", "IID", "PC2_adjsexagegroup")), 
	"C:/Users/uqsvasil/Documents/PhD/MIA/OSCA/OSCA_prep/osca_metagenomics_dietPC2_preadj.pheno",
	col.names = F, row.names = F, sep = "\t", quote = F)
write.table(pheno_diet %>% dplyr::select(c("FID", "IID", "PC3_adjsexagegroup")), 
	"C:/Users/uqsvasil/Documents/PhD/MIA/OSCA/OSCA_prep/osca_metagenomics_dietPC3_preadj.pheno",
	col.names = F, row.names = F, sep = "\t", quote = F)
...
bristol <- diet %>% filter(!(is.na(bristol_stool_chart_regroup)))
pheno_bss <- diet_full[,c("IID", "IID", "bristol_stool_chart_regroup")]
...
write.table(pheno_bss, 
	"C:/Users/uqsvasil/Documents/PhD/MIA/OSCA/OSCA_prep/osca_metagenomics_bristol_regroup.pheno",
	col.names = F, row.names = F, sep = "\t", quote = F)
write.table(pheno_bss, 
	"C:/Users/uqsvasil/Documents/PhD/MIA/OSCA/OSCA_prep/osca_metagenomics_bristol_regroup.cov",
	col.names = F, row.names = F, sep = "\t", quote = F)
write.table(pheno_bss, 
	"C:/Users/uqsvasil/Documents/PhD/MIA/OSCA/OSCA_prep/osca_metagenomics_bristol_regroup.qcov",
	col.names = F, row.names = F, sep = "\t", quote = F)
...
```{r}
# No SIB
no_sib<-subset(pheno, participant_type %in% c("0", "2"))
no_sib_list<-no_sib[ ,c(1,2)]
write.table(no_sib_list, 
	"C:/Users/uqsvasil/Documents/PhD/MIA/OSCA/OSCA_prep/osca_metagenomics_subset_no_sib.list",
	col.names = F, row.names = F, sep = "\t", quote = F)

# No ASD
no_asd<-subset(pheno, participant_type %in% c("0"))
no_asd_list<-no_asd[ ,c(1,2)]
write.table(no_asd_list, 
	"C:/Users/uqsvasil/Documents/PhD/MIA/OSCA/OSCA_prep/osca_metagenomics_subset_no_asd.list",
	col.names = F, row.names = F, sep = "\t", quote = F)

# No AB
no_ab<-subset(pheno, meds_antibiotic_current %in% c("0"))
no_ab_list<-no_ab[ ,c(1,2)]
write.table(no_ab_list, 
	"C:/Users/uqsvasil/Documents/PhD/MIA/OSCA/OSCA_prep/osca_metagenomics_subset_no_ab.list",
	col.names = F, row.names = F, sep = "\t", quote = F)

# No AAP
no_aap<-subset(pheno, meds_antipsychotic %in% c("0"))
no_aap_list<-no_aap[ ,c(1,2)]
write.table(no_aap_list, 
	"C:/Users/uqsvasil/Documents/PhD/MIA/OSCA/OSCA_prep/osca_metagenomics_subset_no_aap.list",
	col.names = F, row.names = F, sep = "\t", quote = F)

# No probiotics
no_probiotic<-subset(pheno, cam_probiotic %in% c("0"))
no_probiotic_list<-no_probiotic[ ,c(1,2)]
write.table(no_probiotic_list, 
	"C:/Users/uqsvasil/Documents/PhD/MIA/OSCA/OSCA_prep/osca_metagenomics_subset_no_probiotic.list",
	col.names = F, row.names = F, sep = "\t", quote = F)

# Full (Non-missing) bristol
bristol
full_bristol_list<-bristol[ ,c("IID","IID")]
full_bristol_list <- full_bristol_list %>% dplyr::rename(FID = IID, IID = IID.1)
  write.table(full_bristol_list, 
	"C:/Users/uqsvasil/Documents/PhD/MIA/OSCA/OSCA_prep/osca_metagenomics_subset_full_bristol.list",
	col.names = F, row.names = F, sep = "\t", quote = F)
...
```{r}
save.image("mia_analysis_04.08.23.Rdata")
#rm(list = ls())
load("mia_analysis_18.04.23.Rdata")
